...
/**************************************************************************/
/*!
  @brief  Backlight brightness adjustment ( added by Proteus )
  @param  blValue    backlight brightness value 0-255
*/
/**************************************************************************/
void Arduino_GFX::setBackLight(uint8_t blValue){

    analogWrite(2,blValue);
    //analogWrite(2,1);
